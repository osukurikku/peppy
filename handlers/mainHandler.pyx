...
class handler(requestsManager.asyncRequestHandler):
	...
	def asyncGet(self):
		...
		html += "              \\ . ..  .. . /<br>"
		html += "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^<br>"
		html += "</marquee><br><strike>reverse engineering a protocol impossible to reverse engineer since always</strike><br>we are actually reverse engineering bancho successfully. for the third time.<br><br><i>&copy; Ripple and Kurikku team, 2019</i></pre></body></html>"
		self.write(html)